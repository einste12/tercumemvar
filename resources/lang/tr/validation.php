...
return [
    ...
    */
    ...
    'custom' => [
        'new_password' => [
            'confirmed' => 'Şifreler Eşleşmiyor Tekrar Deneyiniz',
            'required' =>'Yeni Şifre Alanı Boş Geçilemez',
        ],

        'old_password' => [
            'min:6' => 'Eski Şifre 6 Karakterden Fazla Olmak Zorundadır',
            'required' =>'Eski Şifre Alanı Boş Geçilemez',
        ],


        'new_password_confirmation' => [
            'min:6' => 'Şifre Onayı 6 Karakterden fazla olmak zorundandır',
            'required' =>'Şifre Onaylama Alanı Boş Geçilemez',
        ],
